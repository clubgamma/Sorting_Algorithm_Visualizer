...
algMenu = ttk.Combobox(UI_frame, textvariable=selected_alg, values=['Bubble Sort', 'Quick Sort', 'Merge Sort', 'Selection Sort'])
...
maxEntry = Scale(UI_frame, from_=10, to=500, resolution=1, orient=HORIZONTAL, label="Max Value")
